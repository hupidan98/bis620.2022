...
pcivslanguage <- lm(svi_tb$E_PCI ~ log_transform(svi_tb$E_SPAN) +
                      log_transform(svi_tb$E_CHIN) +
                      log_transform(svi_tb$E_VIET) +
                      log_transform(svi_tb$E_KOR) +
                      log_transform(svi_tb$E_RUS))



pcivsethnicity <- lm(svi_tb$E_PCI ~ log_transform(svi_tb$E_AIAN) +
                       log_transform(svi_tb$E_AFAM) +
                       log_transform(svi_tb$E_NHPI) +
                       log_transform(svi_tb$E_HISP) +
                       log_transform(svi_tb$E_OTHER))


pcivssocialeconomic <- lm(svi_tb$E_PCI ~ log_transform(svi_tb$E_NOHSDP) +
                            log_transform(svi_tb$E_UNEMP) +
                            log_transform(svi_tb$E_NOVEH) +
